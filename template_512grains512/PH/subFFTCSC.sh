...
#SBATCH -J CPparameter
#SBATCH -e CPparameter
...
srun -n 4 /projappl/project_2004956/DAMASK/damask2.0.2/DAMASK/bin/DAMASK_spectral -l tensionX.load -g 512grains512.geom > damask-log.txt
